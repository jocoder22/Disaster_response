...
def data_ww(ggg):
    ...
    barlayout1 = dict(title='Distribution of Message Genres',
    ...
    catseries = (categories_.sum()/categories_.shape[0]*100).sort_values(ascending = False)
    ...
    barlayout2 = dict(title='Distribution of Message Categories',
    ...
    groupbarlayout = dict(barmode='group', title='Distribution of High Message Category by Genre',
                yaxis=dict(title= "Percent"),
